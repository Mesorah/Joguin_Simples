...
def main():
    ...
    print('Você tem 75% de chance de se esquivar, mas você da 2 de dano e se você não se esquivar você toma 3 de dano\033[m')
def vida():
    vida_jogador = 10
    vida_mostro = 25
    começa = randint(1,2)
        ...
        while ataque != 'p':
            while vida_mostro != 0:
                ...
                if ataque not in 'p':
                    ...
                    #usar aqui
                    chance_desvio_automatico = randint(1, 5)
